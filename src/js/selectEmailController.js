function selectEmail(name, email, selectedEmails) {
  ...
  switch(selectedEmails) {
    case 'company-info':
      ...
      emailObj.emailSubject = 'Company Information - Dougherty Brothers Moving';
      break;
    case 'how-to-research':
      ...
      emailObj.emailSubject = 'How to Research Your Movers';
      break;
    case 'get-a-quote-online':
      ...
      emailObj.emailSubject = 'Get a Quote Online';
      break;
    case 'checking-in-about-your-move':
      ...
      emailObj.emailSubject = "Checking In About Your Move";
      break;
    case 'if-your-movers-dont-show-up':
      ...
      emailObj.emailSubject = "If Your Movers Don't Show Up";
      break;
  }
  return emailObj;
}
